...
public class ObjectConsumer {
    ...
    private static final String API_URL = "https://aip.baidubce.com/rest/2.0/image-classify/v2/advanced_general?access_token=" + ACCESS_TOKEN;
    private static final ConcurrentHashMap<String, String> resultsMap = new ConcurrentHashMap<>();

    @RabbitListener(queues = RabbitMqConfig.PIC_Queue)
